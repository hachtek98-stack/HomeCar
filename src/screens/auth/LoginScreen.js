    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <Button
          ...
          accessibilityHint="Se connecter à l'espace patient pour faire une demande"
        />
        ...
        <Button
          ...
          color="#2196F3"
          accessibilityHint="Se connecter à l'espace infirmier pour voir les demandes disponibles"
        />
      </View>
    </View>
  );
