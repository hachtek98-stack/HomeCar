...
// ⚡ Bolt: Extract stateless utility function outside of component to prevent recreation on every render
...
export default function PatientDashboard() {
  ...
  // ⚡ Bolt: Memoize filtered list to prevent breaking FlatList reference equality on re-renders
  ...
  // ⚡ Bolt: Memoize renderItem to leverage FlatList's internal PureComponent optimizations
