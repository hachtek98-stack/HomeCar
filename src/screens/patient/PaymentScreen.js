...
export default function PaymentScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.label} nativeID="paymentPhoneLabel">Numéro de téléphone de paiement</Text>
      <TextInput
        style={styles.input}
        ...
        accessibilityHint="Entrez le numéro de téléphone utilisé pour le paiement Mobile Money"
      />
