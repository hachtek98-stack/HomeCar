...
export default function PaymentScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text nativeID="paymentPhoneLabel" style={styles.label}>Numéro D-Money/Waafi</Text>
      <TextInput
        style={styles.input}
      ...
      <Button
        ...
        color="#4CAF50"
        accessibilityLabel="Valider le paiement Mobile Money"
        accessibilityHint="Initie la procédure de paiement sur votre téléphone"
      />
    </View>
  );
}
